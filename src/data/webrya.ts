import { reviewResourceEntries } from "./review-resource-entries";
...
export const products: Product[] = [
  {
    ...
    includes: ["Damage claim templates", "Photo evidence checklist", "Claim prompts", "Appeal templates"],
  ...
  },
  {
    ...
    includes: ["Bad review analyzer", "Review response templates", "Appeal templates", "AI prompts"],
  ...
  },
  {
    ...
    includes: ["Guest message templates", "Complaint responses", "Cancellation responses", "Check-in / check-out messages", "Emergency communication templates"],
  ...
  },
  {
    ...
    description: "Every major Webrya digital product together, plus the bundle-only operations material. Pay once. Own it.",
    includes: ["AirCover Suite", "Review Protection Suite", "Guest Communication Suite", "Listing optimization workbook", "Turnover & cleaning SOPs", "Lifetime updates"],
    featured: true,
...
export const packages: Pkg[] = [
  {
    ...
    includes: ["Branded property landing page", "Digital guidebook", "3 Webrya AI tools", "Ready-to-use host resources", "Webrya setup"],
    cta: "Get Started",
  },
  {
    slug: "host-pro",
    ...
    includes: ["Premium custom website", "Custom branding & copy", "Full Webrya AI toolkit", "Digital guidebook", "Webrya Workspace setup", "Property-specific resources", "Priority setup"],
    cta: "Choose Host Pro",
    badge: "Most Popular",
    recommended: true,
  },
  {
    ...
    includes: ["Multiple properties", "Multiple users", "Centralized Webrya Workspace", "Custom branding", "White-label options", "Advanced configuration", "Priority support"],
    cta: "Talk to Webrya",
  },
];
...
export const resources: Resource[] = [
  ...reviewResourceEntries,
  {
    slug: "airbnb-hosting-checklist",
    title: "The complete Airbnb hosting setup checklist",
    category: "Airbnb hosting guides",
    excerpt: "From listing photography to your first turnover: the operational checklist experienced hosts run before going live.",
    readTime: "11 min",
  },
  {
    ...
    category: "Airbnb hosting guides",
    excerpt: "Why discounting is the slowest way to fill a calendar, and what to adjust first when occupancy dips.",
    readTime: "8 min",
  },
  {
    ...
    excerpt: "Copy-ready prompts for reviews, guest messages, listing copy and claim documentation.",
    readTime: "7 min",
  },
  {
    ...
    category: "AI for Airbnb hosts",
    excerpt: "The three message points worth automating, and the two you should always write yourself.",
    readTime: "9 min",
  },
  {
    ...
    excerpt: "What to say when a guest complains at midnight, demands a refund, or brings extra people.",
    readTime: "10 min",
  },
  {
